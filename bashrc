#### AUTO GENERATED BY UBUNTY (End line 121)
...
#### AUTO GENERATED BY UBUNTY (Start line 1)

# When building Docker development image, Haskell Stack Tools: WARNING: '/root/.local/bin' is not on your PATH.
...
# "terminal.integrated.fontFamily": "'DroidSansMono for Powerline'"
